<div class="flex flex-row justify-between items-center  p-2 rounded mt-5 shadow">
    <div class="text-gray-800">
        <div class="font-bold text-xl">Filmanet Pos</div>
        <span class="text-xs">Location Filmanet Pos</span>
    </div>
    <div class="flex items-center">
        <div>
            <a class="px-4 py-2 rounded-md cursor-pointer bg-gray-500 text-white" href="route('')">Brands</a>
