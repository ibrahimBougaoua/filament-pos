...
<div wire:click="addProduct({{$id}},'{{$name}}','{{$image}}',{{$price}},'{{$description}}',1,1)" class="px-3 py-3 flex flex-col border cursor-pointer rounded-md shadow h-32 justify-between hover:bg-gray-500/5 focus:bg-gray-500/5">
    <div>
