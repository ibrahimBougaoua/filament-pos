...
<div class="flex flex-row justify-between items-center overflow-y-auto h-32 mb-4 px-2 py-1 cursor-pointer rounded-xl bg-gray-500/5 hover:bg-gray-500/5 focus:bg-gray-500/5">
    @if( ! count($variations) )
        ...
        <div wire:click="removeHoldListItem({{ $key }},{{ $index }})" class="px-2 py-1 cursor-pointer rounded-md shadow-lg text-center bg-white text-white">
